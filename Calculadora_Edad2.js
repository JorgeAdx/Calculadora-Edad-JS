...
if (partes.length !== 3) {                                                      // Verificar que el formato sea DDMMAAAA
    ...
    } else if (annioNac < 1900 || annioNac > fechaHoy.annioHoy) {               // Verificar casos en los que el año sea muy antiguo o futuro
        console.log("El año debe estar entre 1900 y 2025.");
